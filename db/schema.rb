...
ActiveRecord::Schema.define(version: 20180320181908) do
  ...
  create_table "upvotes", force: :cascade do |t|
    ...
    t.index ["video_post_id"], name: "index_upvotes_on_video_post_id"
  end
  ...
  create_table "video_comments", force: :cascade do |t|
    ...
    t.index ["video_post_id"], name: "index_video_comments_on_video_post_id"
  end
